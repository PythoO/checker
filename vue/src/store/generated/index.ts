...
import PythoOCheckersPythooCheckersCheckers from './PythoO/checkers/pythoo.checkers.checkers'
...
export default { 
  PythoOCheckersPythooCheckersCheckers: load(PythoOCheckersPythooCheckersCheckers, 'pythoo.checkers.checkers'),
